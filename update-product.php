        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="admin-content">
              <div class="dv-notify-success alert alert-success">Product edited successfully</div>
              <div class="dv-notify-failed alert alert-danger">Product could not be edited</div>
              <h4 class="text-center">Edit product</h4>
              <p class="mar-bot-30 text-center">The form allows updating of product</p>
